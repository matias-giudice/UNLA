...
;			   descendente hasta 0. El resultado se mostrará en el display. La secuencia se repite indefinidamente. También se puede pausar o
;			   reanudar el proceso con el pulsador RB0, el paso entre número y número es de 1 segundo y se realiza mediante el uso del Timer 0 y 
;			   la interrupción por RB0.
;------------------------------------------------------------
